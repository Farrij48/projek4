        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('https://jatimnow.com/po-content/uploads/IMG_20200411_110034.jpg'); background-size: cover;">
              </div>
            </div>
                ...
                <div class="card-body">
                  <form action="{{ route('register.post') }}" method="POST" role="form">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="email" id="email_address" name="email" class="form-control" required autofocus>
                      @if ($errors->has('email'))
